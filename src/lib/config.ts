...
export const APP_CONFIG = {
  appName: "IEA Portal",                             // Display name (sidebar header, page title)
  projectName: "IEA Certification Portal",           // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,                 // Client first name, or null — never render "null"
  domain: "certification-management",                // Domain classification
