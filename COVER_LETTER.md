...
Is the current schema built to handle multiple certification types per member, or was it extended manually each time you added a new program?

Quick call or I can scope the first sprint in writing. Your pick.

Humam

P.S. Happy to record a quick Loom walkthrough if that's easier.
